...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Modularization/Modularization.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ModularizationDemo/ModularizationDemo.framework"
